...
INSERT INTO `job` VALUES (1,'Update loan Summary','Update loan Summary','0 0 22 1/1 * ? *','2014-04-10 11:24:21',5,NULL,NULL,'2014-04-10 22:00:00','Update loan SummaryJobDetail2 _ DEFAULT',NULL,1,0,1,0,0),(2,'Update Loan Arrears Ageing','Update Loan Arrears Ageing','0 1 0 1/1 * ? *','2014-04-10 11:24:21',5,NULL,NULL,'2014-04-11 00:01:00','Update Loan Arrears AgeingJobDetail2 _ DEFAULT',NULL,1,0,1,0,0),(3,'Update Loan Paid In Advance','Update Loan Paid In Advance','0 5 0 1/1 * ? *','2014-04-10 11:24:21',5,NULL,NULL,'2014-04-11 00:05:00','Update Loan Paid In AdvanceJobDetail2 _ DEFAULT',NULL,1,0,1,0,0),(4,'Apply Annual Fee For Savings','Apply Annual Fee For Savings','0 20 22 1/1 * ? *','2014-04-10 11:24:21',5,NULL,NULL,'2014-04-10 22:20:00','Apply Annual Fee For SavingsJobDetail2 _ DEFAULT',NULL,1,0,1,0,0),(5,'Apply Holidays To Loans','Apply Holidays To Loans','0 0 12 * * ?','2014-04-10 11:24:21',5,NULL,NULL,'2014-04-10 12:00:00','Apply Holidays To LoansJobDetail2 _ DEFAULT',NULL,1,0,1,0,0),(6,'Post Interest For Savings','Post Interest For Savings','0 0 0 1/1 * ? *','2014-04-10 11:24:29',5,NULL,NULL,'2014-04-11 00:00:00','Post Interest For SavingsJobDetail2 _ DEFAULT',NULL,1,0,1,0,0),(7,'Transfer Fee For Loans From Savings','Transfer Fee For Loans From Savings','0 1 0 1/1 * ? *','2014-04-10 11:24:41',5,NULL,NULL,'2014-04-11 00:01:00','Transfer Fee For Loans From SavingsJobDetail2 _ DEFAULT',NULL,1,0,1,0,0),(8,'Pay Due Savings Charges','Pay Due Savings Charges','0 0 12 * * ?','2013-09-23 00:00:00',5,NULL,NULL,'2014-04-10 12:00:00','Pay Due Savings ChargesJobDetail2 _ DEFAULT',NULL,1,0,1,0,0),(9,'Update Accounting Running Balances','Update Accounting Running Balances','0 1 0 1/1 * ? *','2014-04-10 11:24:45',5,NULL,NULL,'2014-04-11 00:01:00','Update Accounting Running BalancesJobDetail2 _ DEFAULT',NULL,1,0,1,0,0);
...
INSERT INTO `m_appuser` VALUES (1,0,1,NULL,'mifos','App','Administrator','5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a','demomfi@mifos.org','\0','','','','','2014-04-10');
...
INSERT INTO `m_code_value` VALUES (1,1,'Passport',1),(2,1,'Id',2),(3,1,'Drivers License',3),(4,1,'Any Other Id Type',4),(5,6,'Spouse',0),(6,6,'Parent',0),(7,6,'Sibling',0),(8,6,'Business Associate',0),(9,6,'Other',0);
...
INSERT INTO `schema_version` VALUES (1,1,'1','mifosplatform-core-ddl-latest','SQL','V1__mifosplatform-core-ddl-latest.sql',1800446512,'root','2014-04-10 05:53:41',12801,1),(10,10,'10','interest-posting-fields-for-savings','SQL','V10__interest-posting-fields-for-savings.sql',-336990098,'root','2014-04-10 05:53:48',951,1),(100,100,'100','Group saving summary report','SQL','V100__Group_saving_summary_report.sql',-1635399448,'root','2014-04-10 05:54:32',39,1),(101,101,'101','add mulitplesof to account transfers table','SQL','V101__add_mulitplesof_to_account_transfers_table.sql',-309641296,'root','2014-04-10 05:54:33',273,1),(102,102,'102','client attendance tables','SQL','V102__client_attendance_tables.sql',1698025788,'root','2014-04-10 05:54:33',328,1),(103,103,'103','cluster support for batch jobs','SQL','V103__cluster_support_for_batch_jobs.sql',-440433843,'root','2014-04-10 05:54:34',456,1),(104,104,'104','permissions for transfers','SQL','V104__permissions_for_transfers.sql',-367794784,'root','2014-04-10 05:54:34',45,1),(105,105,'105','track loan transaction against office','SQL','V105__track_loan_transaction_against_office.sql',460401960,'root','2014-04-10 05:54:35',835,1),(106,106,'106','more permissions for transfers','SQL','V106__more_permissions_for_transfers.sql',1090824664,'root','2014-04-10 05:54:35',47,1),(107,107,'107','datatable code mappings','SQL','V107__datatable_code_mappings.sql',1534043325,'root','2014-04-10 05:54:35',186,1),(108,108,'108','client has transfer office','SQL','V108__client_has_transfer_office.sql',1659150580,'root','2014-04-10 05:54:36',253,1),(109,109,'109','account transfer withdrawal fee configuration','SQL','V109__account_transfer_withdrawal_fee_configuration.sql',572922712,'root','2014-04-10 05:54:36',685,1),(11,11,'11','add-payment-details','SQL','V11__add-payment-details.sql',2055233524,'root','2014-04-10 05:53:48',563,1),(110,110,'110','group center close','SQL','V110__group_center_close.sql',592532718,'root','2014-04-10 05:54:37',345,1),(111,111,'111','disable constraint approach for datatables by default','SQL','V111__disable_constraint_approach_for_datatables_by_default.sql',2058257907,'root','2014-04-10 05:54:37',44,1),(112,112,'111.1','set default transfers in suspense account for existing loan products','SQL','V111_1__set default_transfers_in_suspense_account_for_existing_loan_products.sql',-2022488149,'root','2014-04-10 05:54:37',2,1),(113,113,'112','mixreport sql support','SQL','V112__mixreport_sql_support.sql',1375191923,'root','2014-04-10 05:54:38',542,1),(114,114,'113','track savings transaction against office','SQL','V113__track_savings_transaction_against_office.sql',-443279148,'root','2014-04-10 05:54:38',830,1),(115,115,'114','set default transfers in suspense account for existing savings products - Copy','SQL','V114__set_default_transfers_in_suspense_account_for_existing_savings_products - Copy.sql',-1403120536,'root','2014-04-10 05:54:39',2,1),(116,116,'115','permissions for cache api','SQL','V115__permissions_for_cache_api.sql',-1970721857,'root','2014-04-10 05:54:39',146,1),(117,117,'116','track currency for journal entries','SQL','V116__track_currency_for_journal_entries.sql',-1108820305,'root','2014-04-10 05:54:40',807,1),(118,118,'117','loan charge from savings','SQL','V117__loan_charge_from_savings.sql',954217442,'root','2014-04-10 05:54:41',815,1),(119,119,'118','savings charge','SQL','V118__savings_charge.sql',1334878019,'root','2014-04-10 05:54:41',578,1),(120,120,'118.1','savings charge patch update','SQL','V118_1__savings_charge_patch_update.sql',681062374,'root','2014-04-10 05:54:42',315,1),(121,121,'118.2','product mapping delete duplicate fund source to account mappings','SQL','V118_2__product_mapping_delete_duplicate_fund_source_to_account_mappings.sql',139468093,'root','2014-04-10 05:54:42',2,1),(122,122,'118.3','permissions form propose and accept client transfers','SQL','V118_3__permissions_form_propose_and_accept_client_transfers.sql',34987858,'root','2014-04-10 05:54:42',45,1),(123,123,'118.4','reset default transfers in suspense account for existing savings products','SQL','V118_4__reset_default_transfers_in_suspense_account_for_existing_savings_products.sql',-699275732,'root','2014-04-10 05:54:42',2,1),(124,124,'118.5','batch job entry for pay savings charge','SQL','V118_5__batch_job_entry_for_pay_savings_charge.sql',11127915,'root','2014-04-10 05:54:42',40,1),(125,125,'118.6','defaults for income from penalties for savings product','SQL','V118_6__defaults_for_income_from_penalties_for savings_product.sql',-1604260872,'root','2014-04-10 05:54:42',3,1),(126,126,'118.7','move withdrawal annual fee to charges','SQL','V118_7__move_withdrawal_annual_fee_to_charges.sql',-1713639384,'root','2014-04-10 05:54:44',1565,1),(127,127,'118.8','track overpayments seperately in loan transactions','SQL','V118_8__track_overpayments_seperately_in_loan_transactions.sql',2134928751,'root','2014-04-10 05:54:44',333,1),(128,128,'119','add template table','SQL','V119__add_template_table.sql',1742102552,'root','2014-04-10 05:54:45',446,1),(12,12,'12','add external id to couple of tables','SQL','V12__add_external_id_to_couple_of_tables.sql',883650693,'root','2014-04-10 05:53:50',1673,1),(129,129,'120','accounting running balance','SQL','V120__accounting_running_balance.sql',-1849380605,'root','2014-04-10 05:54:45',331,1),(130,130,'121','accounting running balance for organization','SQL','V121__accounting_running_balance_for_organization.sql',-109322315,'root','2014-04-10 05:54:46',406,1),(131,131,'122','recurring fee support for savings','SQL','V122__recurring_fee_support_for_savings.sql',-1243503882,'root','2014-04-10 05:54:46',461,1),(132,132,'123','remove payment mode for savings','SQL','V123__remove_payment_mode_for_savings.sql',-310516979,'root','2014-04-10 05:54:47',537,1),(133,133,'124','added min max cap for charges','SQL','V124__added_min_max_cap_for_charges.sql',-1996899270,'root','2014-04-10 05:54:48',535,1),(134,134,'125','added column for actual fee amount or percentage','SQL','V125__added_column_for_actual_fee_amount_or_percentage.sql',-1902751935,'root','2014-04-10 05:54:48',293,1),(135,135,'126','initial database structure for sms outbound','SQL','V126__initial_database_structure_for_sms_outbound.sql',-525419057,'root','2014-04-10 05:54:48',244,1),(136,136,'127','mobile no fields','SQL','V127__mobile_no_fields.sql',1414744294,'root','2014-04-10 05:54:49',602,1),(137,137,'128','added loan installment charge','SQL','V128__added_loan_installment_charge.sql',-427737636,'root','2014-04-10 05:54:49',152,1),(138,138,'129','client and group timeline','SQL','V129__client_and_group_timeline.sql',-354048349,'root','2014-04-10 05:54:50',552,1),(13,13,'13','add group and client pending configuration','SQL','V13__add_group_and_client_pending_configuration.sql',1362148042,'root','2014-04-10 05:53:50',120,1),(139,139,'130','calendar-history-table','SQL','V130__calendar-history-table.sql',-1068056425,'root','2014-04-10 05:54:50',182,1),(140,140,'131','holiday-status-column-and-permissions','SQL','V131__holiday-status-column-and-permissions.sql',-1167988339,'root','2014-04-10 05:54:51',560,1),(141,141,'132','borrower cycle changes','SQL','V132__borrower_cycle_changes.sql',-1484124924,'root','2014-04-10 05:54:51',398,1),(142,142,'133','adding payment detail with journal entry','SQL','V133__adding_payment_detail_with_journal_entry.sql',363269207,'root','2014-04-10 05:54:52',276,1),(143,143,'134','added column value on c configuration','SQL','V134__added_column_value_on_c_configuration.sql',-30626232,'root','2014-04-10 05:54:52',356,1),(144,144,'134.1','submitted date updation for clients','SQL','V134_1__submitted_date_updation_for_clients.sql',-935202259,'root','2014-04-10 05:54:52',4,1),(145,145,'134.2','permissions spelling correction','SQL','V134_2__permissions_spelling_correction.sql',-1824098129,'root','2014-04-10 05:54:52',48,1),(146,146,'135','added permission for undo written off','SQL','V135__added_permission_for_undo_written_off.sql',426644857,'root','2014-04-10 05:54:52',43,1),(147,147,'136.1','update script strechy parameter','SQL','V136_1__update_script_strechy_parameter.sql',633461657,'root','2014-04-10 05:54:53',46,1),(148,148,'137','added is active column in m staff','SQL','V137__added_is_active_column_in_m_staff.sql',1962782431,'root','2014-04-10 05:54:53',228,1),(149,149,'138','add short name for m product loan and m savings product','SQL','V138__add_short_name_for_m_product_loan_and_m_savings_product.sql',-1906630344,'root','2014-04-10 05:54:54',1409,1),(150,150,'139','default value for is active updated to true in m staff','SQL','V139__default_value_for_is_active_updated_to_true_in_m_staff.sql',1106637014,'root','2014-04-10 05:54:55',237,1),(14,14,'14','rename status id to enum','SQL','V14__rename_status_id_to_enum.sql',-309404445,'root','2014-04-10 05:53:51',1053,1),(151,151,'140','added loan charge status','SQL','V140__added_loan_charge_status.sql',701858626,'root','2014-04-10 05:54:55',244,1),(152,152,'140.1','added payment detail id in ac gl journal entry','SQL','V140_1__added_payment_detail_id_in_ac_gl_journal_entry.sql',-2051594288,'root','2014-04-10 05:54:55',313,1),(153,153,'141','add early repayment strategy','SQL','V141__add_early_repayment_strategy.sql',1510094803,'root','2014-04-10 05:54:56',46,1),(154,154,'142','read savingsaccount charge permission','SQL','V142__read_savingsaccount_charge_permission.sql',643820806,'root','2014-04-10 05:54:56',45,1),(155,155,'143','create journalentry checker permission','SQL','V143__create_journalentry_checker_permission.sql',1931469061,'root','2014-04-10 05:54:56',46,1),(156,156,'144','spelling mistake corrections','SQL','V144__spelling_mistake_corrections.sql',196034832,'root','2014-04-10 05:54:56',284,1),(157,157,'145','add force password reset in c configuration','SQL','V145__add_force_password_reset_in_c_configuration.sql',521336058,'root','2014-04-10 05:54:57',717,1),(158,158,'146','tranche loans','SQL','V146__tranche_loans.sql',1531299564,'root','2014-04-10 05:54:58',752,1),(159,159,'147','tranche loans column name changes','SQL','V147__tranche_loans_column_name_changes.sql',400468365,'root','2014-04-10 05:54:58',232,1),(160,160,'148','overdraft changes','SQL','V148__overdraft_changes.sql',-125453644,'root','2014-04-10 05:54:59',1038,1),(161,161,'149','add created date savings transaction','SQL','V149__add_created_date_savings_transaction.sql',1388322313,'root','2014-04-10 05:55:00',235,1),(15,15,'15','center permissions','SQL','V15__center_permissions.sql',2015498904,'root','2014-04-10 05:53:51',44,1),(162,162,'150','basic savings report','SQL','V150__basic_savings_report.sql',-1950444456,'root','2014-04-10 05:55:00',373,1),(163,163,'151','add default savings account to client','SQL','V151__add_default_savings_account_to_client.sql',1421080968,'root','2014-04-10 05:55:01',607,1),(164,164,'152','added grace for over due','SQL','V152__added_grace_for_over_due.sql',-1487653468,'root','2014-04-10 05:55:02',624,1),(165,165,'153','Insert missed permissions','SQL','V153__Insert_missed_permissions.sql',1384787449,'root','2014-04-10 05:55:02',46,1),(166,166,'154','aging details','SQL','V154__aging_details.sql',1117759702,'root','2014-04-10 05:55:02',53,1),(167,167,'155','stretchy into pentaho','SQL','V155__stretchy_into_pentaho.sql',264756763,'root','2014-04-10 05:55:02',154,1),(168,168,'156','added loan saving txns pentaho','SQL','V156__added_loan_saving_txns_pentaho.sql',1288577073,'root','2014-04-10 05:55:02',47,1),(169,169,'157','overdue charge improvements','SQL','V157__overdue_charge_improvements.sql',-1315687034,'root','2014-04-10 05:55:03',463,1),(170,170,'158','dashboard and navigation queries','SQL','V158__dashboard_and_navigation_queries.sql',555462763,'root','2014-04-10 05:55:03',57,1),(16,16,'16','drop min max column on loan table','SQL','V16__drop_min_max_column_on_loan_table.sql',120700748,'root','2014-04-10 05:53:52',483,1),(17,17,'17','update stretchy reporting ddl','SQL','V17__update_stretchy_reporting_ddl.sql',1711192696,'root','2014-04-10 05:53:54',2071,1),(18,18,'18','update stretchy reporting reportSql','SQL','V18__update_stretchy_reporting_reportSql.sql',1325342044,'root','2014-04-10 05:53:54',85,1),(19,19,'19','report maintenance permissions','SQL','V19__report_maintenance_permissions.sql',-2056587297,'root','2014-04-10 05:53:54',45,1),(2,2,'2','mifosx-base-reference-data-utf8','SQL','V2__mifosx-base-reference-data-utf8.sql',-1364356239,'root','2014-04-10 05:53:41',83,1),(20,20,'20','report maint perms really configuration','SQL','V20__report_maint_perms_really_configuration.sql',-796088526,'root','2014-04-10 05:53:55',44,1),(21,21,'21','activation-permissions-for-clients','SQL','V21__activation-permissions-for-clients.sql',1555848180,'root','2014-04-10 05:53:55',361,1),(22,22,'22','alter-group-for-consistency-add-permissions','SQL','V22__alter-group-for-consistency-add-permissions.sql',-968577287,'root','2014-04-10 05:53:56',1406,1),(23,23,'23','remove-enable-disable-configuration-for-client-group-status','SQL','V23__remove-enable-disable-configuration-for-client-group-status.sql',1496208571,'root','2014-04-10 05:53:57',616,1),(24,24,'24','add-group-client-foreign-key-constraint-in-loan-table','SQL','V24__add-group-client-foreign-key-constraint-in-loan-table.sql',1077707078,'root','2014-04-10 05:53:58',662,1),(25,25,'25','update client reports for status and activation change','SQL','V25__update_client_reports_for_status_and_activation_change.sql',-804917415,'root','2014-04-10 05:53:58',48,1),(26,26,'26','add-support-for-withdrawal-fees-on-savings','SQL','V26__add-support-for-withdrawal-fees-on-savings.sql',-16474046,'root','2014-04-10 05:53:59',1050,1),(27,27,'27','add-loan-type-column-to-loan-table','SQL','V27__add-loan-type-column-to-loan-table.sql',-2130377861,'root','2014-04-10 05:54:00',540,1),(28,28,'28','accounting-abstractions-and-autoposting','SQL','V28__accounting-abstractions-and-autoposting.sql',409111061,'root','2014-04-10 05:54:01',644,1),(29,29,'29','add-support-for-annual-fees-on-savings','SQL','V29__add-support-for-annual-fees-on-savings.sql',1605784460,'root','2014-04-10 05:54:02',955,1),(3,3,'3','mifosx-permissions-and-authorisation-utf8','SQL','V3__mifosx-permissions-and-authorisation-utf8.sql',799772833,'root','2014-04-10 05:53:41',75,1),(30,30,'30','add-referenceNumber-to-acc gl journal entry','SQL','V30__add-referenceNumber-to-acc_gl_journal_entry.sql',-1775379589,'root','2014-04-10 05:54:02',305,1),(31,31,'31','drop-autopostings','SQL','V31__drop-autopostings.sql',-470157621,'root','2014-04-10 05:54:02',52,1),(32,32,'32','associate-disassociate-clients-from-group-permissions','SQL','V32__associate-disassociate-clients-from-group-permissions.sql',-947369256,'root','2014-04-10 05:54:02',49,1),(33,33,'33','drop unique check on stretchy report parameter','SQL','V33__drop_unique_check_on_stretchy_report_parameter.sql',-1599579296,'root','2014-04-10 05:54:03',182,1),(34,34,'34','add unique check on stretchy report parameter','SQL','V34__add_unique_check_on_stretchy_report_parameter.sql',108622279,'root','2014-04-10 05:54:03',203,1),(35,35,'35','add hierarchy column for acc gl account','SQL','V35__add_hierarchy_column_for_acc_gl_account.sql',-1387013309,'root','2014-04-10 05:54:03',304,1),(36,36,'36','add tag id column for acc gl account','SQL','V36__add_tag_id_column_for_acc_gl_account.sql',414916166,'root','2014-04-10 05:54:04',414,1),(37,37,'37','add-center-group-collection-sheet-permissions','SQL','V37__add-center-group-collection-sheet-permissions.sql',-1268924209,'root','2014-04-10 05:54:04',44,1),(38,38,'38','add-group-summary-details-report','SQL','V38__add-group-summary-details-report.sql',-1925018160,'root','2014-04-10 05:54:04',46,1),(39,39,'39','payment-channels-updates','SQL','V39__payment-channels-updates.sql',1970858040,'root','2014-04-10 05:54:05',1021,1),(4,4,'4','mifosx-core-reports-utf8','SQL','V4__mifosx-core-reports-utf8.sql',-621034771,'root','2014-04-10 05:53:42',632,1),(40,40,'40','add permissions for accounting rule','SQL','V40__add_permissions_for_accounting_rule.sql',1514233058,'root','2014-04-10 05:54:05',46,1),(41,41,'41','group-summary-reports','SQL','V41__group-summary-reports.sql',19296882,'root','2014-04-10 05:54:05',49,1),(42,42,'42','Add default value for id for acc accounting rule','SQL','V42__Add_default_value_for_id_for_acc_accounting_rule.sql',2059436790,'root','2014-04-10 05:54:06',506,1),(43,43,'43','accounting-for-savings','SQL','V43__accounting-for-savings.sql',581527903,'root','2014-04-10 05:54:07',545,1),(44,44,'44','document-increase-size-of-column-type','SQL','V44__document-increase-size-of-column-type.sql',1059756585,'root','2014-04-10 05:54:07',236,1),(45,45,'45','create acc rule tags table','SQL','V45__create_acc_rule_tags_table.sql',-1290711661,'root','2014-04-10 05:54:07',222,1),(46,46,'46','extend datatables api','SQL','V46__extend_datatables_api.sql',-720503052,'root','2014-04-10 05:54:07',43,1),(47,47,'47','staff-hierarchy-link-to-users','SQL','V47__staff-hierarchy-link-to-users.sql',-781472323,'root','2014-04-10 05:54:09',1251,1),(48,48,'48','adding-S3-Support','SQL','V48__adding-S3-Support.sql',2067568267,'root','2014-04-10 05:54:10',1166,1),(49,49,'49','track-loan-charge-payment-transactions','SQL','V49__track-loan-charge-payment-transactions.sql',239889520,'root','2014-04-10 05:54:10',225,1),(5,5,'5','update-savings-product-and-account-tables','SQL','V5__update-savings-product-and-account-tables.sql',1084497355,'root','2014-04-10 05:53:43',936,1),(50,50,'50','add-grace-settings-to-loan-product','SQL','V50__add-grace-settings-to-loan-product.sql',930022178,'root','2014-04-10 05:54:11',658,1),(51,51,'51','track-additional-details-related-to-installment-performance','SQL','V51__track-additional-details-related-to-installment-performance.sql',1962138500,'root','2014-04-10 05:54:12',710,1),(52,52,'52','add boolean support cols to acc accounting rule','SQL','V52__add_boolean_support_cols_to_acc_accounting_rule.sql',-2052189586,'root','2014-04-10 05:54:12',547,1),(53,53,'53','track-advance-and-late-payments-on-installment','SQL','V53__track-advance-and-late-payments-on-installment.sql',1135041990,'root','2014-04-10 05:54:13',269,1),(54,54,'54','charge-to-income-account-mappings','SQL','V54__charge-to-income-account-mappings.sql',-302610090,'root','2014-04-10 05:54:13',266,1),(55,55,'55','add-additional-transaction-processing-strategies','SQL','V55__add-additional-transaction-processing-strategies.sql',-1410997541,'root','2014-04-10 05:54:14',471,1),(56,56,'56','track-overpaid-amount-on-loans','SQL','V56__track-overpaid-amount-on-loans.sql',1759551652,'root','2014-04-10 05:54:14',421,1),(57,57,'57','add default values to debit and credit accounts acc accounting rule','SQL','V57__add_default_values_to_debit_and_credit_accounts_acc_accounting_rule.sql',1041459650,'root','2014-04-10 05:54:15',295,1),(58,58,'58','create-holiday-tables changed','SQL','V58__create-holiday-tables_changed.sql',-1395337105,'root','2014-04-10 05:54:15',346,1),(59,59,'59','add group roles schema and permissions','SQL','V59__add_group_roles_schema_and_permissions.sql',-406383935,'root','2014-04-10 05:54:15',408,1),(6,6,'6','add min max principal column to loan','SQL','V6__add_min_max_principal_column_to_loan.sql',595333955,'root','2014-04-10 05:53:44',1109,1),(60,60,'60','quipo dashboard reports','SQL','V60__quipo_dashboard_reports.sql',-692899146,'root','2014-04-10 05:54:16',68,1),(61,61,'61','txn running balance example','SQL','V61__txn_running_balance_example.sql',1606019935,'root','2014-04-10 05:54:16',53,1),(62,62,'62','add staff id to m client changed','SQL','V62__add_staff_id_to_m_client_changed.sql',1148218006,'root','2014-04-10 05:54:16',358,1),(63,63,'63','add sync disbursement with meeting column to loan','SQL','V63__add_sync_disbursement_with_meeting_column_to_loan.sql',1201879376,'root','2014-04-10 05:54:17',408,1),(64,64,'64','add permission for assign staff','SQL','V64__add_permission_for_assign_staff.sql',-1938102414,'root','2014-04-10 05:54:17',46,1),(65,65,'65','fix rupee symbol issues','SQL','V65__fix_rupee_symbol_issues.sql',1008895069,'root','2014-04-10 05:54:17',43,1),(66,66,'66','client close functionality','SQL','V66__client_close_functionality.sql',-40177829,'root','2014-04-10 05:54:18',498,1),(67,67,'67','loans in advance table','SQL','V67__loans_in_advance_table.sql',-1142949220,'root','2014-04-10 05:54:18',125,1),(68,68,'68','quipo dashboard reports updated','SQL','V68__quipo_dashboard_reports_updated.sql',-516501676,'root','2014-04-10 05:54:18',74,1),(69,69,'69','loans in advance initialise','SQL','V69__loans_in_advance_initialise.sql',-1373592344,'root','2014-04-10 05:54:18',50,1),(7,7,'7','remove read makerchecker permission','SQL','V7__remove_read_makerchecker_permission.sql',-1997435240,'root','2014-04-10 05:53:44',49,1),(70,70,'70','quipo program detail query fix','SQL','V70__quipo_program_detail_query_fix.sql',1054866372,'root','2014-04-10 05:54:18',69,1),(71,71,'71','insert reschedule repayment to configuration','SQL','V71__insert_reschedule_repayment_to_configuration.sql',-1148306529,'root','2014-04-10 05:54:18',66,1),(72,72,'72','add m loan counter changes','SQL','V72__add_m_loan_counter_changes.sql',583448067,'root','2014-04-10 05:54:19',544,1),(73,73,'73','add repayments rescheduled to and processed column to holiday','SQL','V73__add_repayments_rescheduled_to_and_processed_column_to_holiday.sql',-503832337,'root','2014-04-10 05:54:19',246,1),(74,74,'74','alter m loan counter table add group','SQL','V74__alter_m_loan_counter_table_add_group.sql',-2117284805,'root','2014-04-10 05:54:20',591,1),(75,75,'75','add reschedule-repayments-on-holidays to configuration','SQL','V75__add_reschedule-repayments-on-holidays_to_configuration.sql',1328301697,'root','2014-04-10 05:54:20',49,1),(76,76,'76','rename permission grouping','SQL','V76__rename_permission_grouping.sql',782643717,'root','2014-04-10 05:54:20',48,1),(77,77,'77','alter m product loan changes','SQL','V77__alter_m_product_loan_changes.sql',-1168017986,'root','2014-04-10 05:54:21',363,1),(78,78,'78','breakdown portfolio grouping','SQL','V78__breakdown_portfolio_grouping.sql',-1151517023,'root','2014-04-10 05:54:21',50,1),(79,79,'79','schedule jobs tables','SQL','V79__schedule_jobs_tables.sql',1092941601,'root','2014-04-10 05:54:21',256,1),(8,8,'8','deposit-transaction-permissions-if-they-exist','SQL','V8__deposit-transaction-permissions-if-they-exist.sql',698638936,'root','2014-04-10 05:53:44',2,1),(80,80,'80','schedule jobs tables updates','SQL','V80__schedule_jobs_tables_updates.sql',427508507,'root','2014-04-10 05:54:23',1217,1),(81,81,'81','savings related changes','SQL','V81__savings_related_changes.sql',33715259,'root','2014-04-10 05:54:25',1961,1),(82,82,'82','schedule jobs tables updates for running status','SQL','V82__schedule_jobs_tables_updates_for_running_status.sql',1680141153,'root','2014-04-10 05:54:25',569,1),(83,83,'83','non-working-days-table','SQL','V83__non-working-days-table.sql',7304707,'root','2014-04-10 05:54:26',173,1),(84,84,'84','undo savings transaction permission','SQL','V84__undo_savings_transaction_permission.sql',-1712636214,'root','2014-04-10 05:54:26',81,1),(85,85,'85','product mix related changes','SQL','V85__product_mix_related_changes.sql',-1558734721,'root','2014-04-10 05:54:26',505,1),(86,86,'86','update-working-days','SQL','V86__update-working-days.sql',1751835641,'root','2014-04-10 05:54:26',101,1),(87,87,'87','add permission for scheduler','SQL','V87__add_permission_for_scheduler.sql',-575950289,'root','2014-04-10 05:54:27',108,1),(88,88,'88','added update constrain for scheduler jobs','SQL','V88__added_update_constrain_for_scheduler_jobs.sql',-897794717,'root','2014-04-10 05:54:27',275,1),(89,89,'89','added scheduler group','SQL','V89__added_scheduler_group.sql',-1570560491,'root','2014-04-10 05:54:27',280,1),(9,9,'9','add min max constraint column to loan loanproduct','SQL','V9__add_min_max_constraint_column_to_loan_loanproduct.sql',2075080909,'root','2014-04-10 05:53:46',2052,1),(90,90,'90','client performance history reports','SQL','V90__client_performance_history_reports.sql',-358569421,'root','2014-04-10 05:54:28',64,1),(91,91,'91','apply annual fees permission','SQL','V91__apply_annual_fees_permission.sql',1152030995,'root','2014-04-10 05:54:28',48,1),(92,92,'91.1','configuration settings for holiday and non workingday','SQL','V91_1__configuration_settings_for_holiday_and_non_workingday.sql',2070643129,'root','2014-04-10 05:54:28',53,1),(93,93,'92','group center assign staff permission','SQL','V92__group_center_assign_staff_permission.sql',-1280675809,'root','2014-04-10 05:54:28',49,1),(94,94,'93','loan transaction external id','SQL','V93__loan_transaction_external_id.sql',-1876913209,'root','2014-04-10 05:54:28',293,1),(95,95,'94','added savings accont type','SQL','V94__added_savings_accont type.sql',-947513684,'root','2014-04-10 05:54:29',406,1),(96,96,'95','batch job postInterest','SQL','V95__batch_job_postInterest.sql',2096051563,'root','2014-04-10 05:54:29',85,1),(97,97,'96','savings accounts transfers table','SQL','V96__savings_accounts_transfers_table.sql',1113386790,'root','2014-04-10 05:54:30',641,1),(98,98,'97','add permission for adjust savings transaction','SQL','V97__add_permission_for_adjust_savings_transaction.sql',-2045732265,'root','2014-04-10 05:54:30',51,1),(99,99,'98','added currency roundof for multipleof','SQL','V98__added_currency_roundof_for_multipleof.sql',1195011921,'root','2014-04-10 05:54:32',2233,1);
...
-- Dump completed on 2014-04-10 11:30:58
